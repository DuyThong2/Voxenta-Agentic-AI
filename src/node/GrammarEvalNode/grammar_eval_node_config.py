...
def build_user_prompt(transcript: str, reference_text: str | None, mode: str) -> str:
    ...
    if mode == "scripted":
        parts.append("\nThe speaker was reading the reference text aloud. Evaluate grammatical range and accuracy against the reference.")
    else:
        parts.append("\nThe speaker was speaking freely. Evaluate grammatical range and accuracy in their spontaneous speech.")
