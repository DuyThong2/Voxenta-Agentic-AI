...
def build_framework_note(
    ...
    Ban LUYEN TAP: goi thang sau khi Azure tra diem, KHONG qua buoc anh xa nao --
    thang 0-100 cua Azure chinh la thang cham. (Ban thi: AzureScoreScaleNode goi sau khi doi
    HundredMark sang dai rubric.)
